export const buttonCopyRounded = (idButton: string) => /*html*/ `
<button id="${idButton}" class="btn-copy-code" tabindex="2"
...
export const buttonCopyRoundedLeft = (idButton: string) => /*html*/ `
<button id="${idButton}" class="btn-copy-code-adj-pos" tabindex="2"
  ...
  >
    <div role="button" tabindex="0"
      ...
      class="copy">
      <svg role="graphics-symbol" viewBox="0 0 14 16"
        style="width: 16px; height: 16px; display: block; fill: #fff; flex-shrink: 0; padding-right: 4px;">
