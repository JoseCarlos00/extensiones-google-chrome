...
export async function getHtmlContent({ sectionContainerClass, modalId }) {
  const btnCopy = /*html*/ `
    ...
    <div class="code-container position-relative language-sql hljs">
      ...
      <div class="internal-num-code">
        ...
        <div class="container-internal-inventory-numbers single-internal">
          <span class="ms-2 hljs-keyword alin-top multi-internal">IN&nbsp;</span><span
  ...
  modal.insertContentModal(containerMain);
