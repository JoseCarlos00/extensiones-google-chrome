...
export class InternalNUmber extends HandlerTemplate {
	constructor({ prefixClass }: { prefixClass: string}) {
		super({ prefixClass, idBtnCopy: idBtnCopyInternalNumber, idInputOh, idInputAl, idInputIt, idInputSu, idInternalNumberInv, eventManagerSelectors: { containerPrincipalSelector: 'internal-number', inputCheckboxSelector: 'internal-number' }});
	}
}
