...
const { idBtnCopyItemLocation, idInputOH, idInputAL, idInputIT, idInputSU: idInputSU, idInternalNumberInv: idInternalInvNumber } = itemLocation;

const btnCopyInternalNumber = buttonCopyRounded(idBtnCopyItemLocation);
...
containerMain.className = 'main-code-container item-location single OH AL IT';
