...
if (ruta === 'http://fmorion.dnsalias.com/orion/paginas/Envios/Envio.aspx?EnvioNum=') {
    ...
    document.querySelector("#UpdatePanel > main > div.d-flex.bd-highlight > div.flex-grow-1.bd-highlight").style = 'padding-right: calc(88.22px + 0.5rem*2 + 0.5rem + 110.18px);';
}
