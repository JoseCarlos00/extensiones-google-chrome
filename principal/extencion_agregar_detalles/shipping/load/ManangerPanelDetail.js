class ManangerPanelDetailShippingLoad extends ManangerPanelDetail {
	...
	_insertElementsHtml() {
		return new Promise((resolve, reject) => {
			...
			const trailingElment = this.panelDetail.querySelector("#ScreenControlLabel35792");
			const leadingElement = this.panelDetail.querySelector("#ScreenControlLabel35791");
