class HandleShippingContainer extends HandlePanelDetail {
  ...
  _extraerDatosDeTr(tr) {
    ...
    const parentContainerId = this._extractAndTrim(
      tr.querySelector(this.internalData.parentContainerId)
    );
    const shipmentId = this._extractAndTrim(tr.querySelector(this.internalData.shipmentId));
    const statusNumeric = this._extractAndTrim(
      tr.querySelector(this.internalData.statusNumeric),
      '—'
    );
    ...
    const internalContainerNum = this._extractAndTrim(
      tr.querySelector(this.internalData.internalContainerNum),
      '—'
    );
