class HandleLineInsight extends HandlePanelDetailDataExternal {
	...
	_extraerDatosDeTr(tr) {
		...
		const internalShipmentLineNum = this._extractAndTrim(tr.querySelector(this.internalData.internalShipmentLineNum));
	...
	_updateDetailsPanelInfo(datos) {
		try {
			...
			if (this.internalPanelElements.internalShipmentNum.textContent.trim() === internalShipmentNumber) {
