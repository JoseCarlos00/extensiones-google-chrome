import { ModalCreateHTML } from "../ModaCreateHTML";

export async function getHtmlContentItem({ sectionContainerClass, modalId }) {
	const modalContent = `
    <form id="formInsertItem" class="insertar-item">
      ...
      <textarea id="insertItem"  name="insertItem" required placeholder="Item:9413-6209-34996\Qty:24"></textarea>
