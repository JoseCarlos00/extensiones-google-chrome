class CheckBookMananger {
  ...
  createCheckboxElements(columnsToShow = [], showColumns = true) {
   ...
   */
  createFiltersCheckbox(columnsToShow = [], showColumns = true) {
  ...
  /** Filter Group */
  async createCheckboxElementsGroup(columnsDefaul = [], show = true) {
    return new Promise((resolve, reject) => {
  ...
  createFiltersCheckboxRow(columnsToShow = [], showColumns = true) {
